...
export default async function InstructorExamQuestionsPage({
  params,
}: PageProps) {
      ...
      >
        <section className="border border-[#c9a84c]/20 bg-white/90 p-8">
          <p className="text-[#1c2b3a]/70">
            You cannot manage questions for an assessment outside your assigned
            courses.
          </p>
  ...
  async function addQuestion(formData: FormData) {
    ...
    if (!assignedCourse) {
      throw new Error(
        "You cannot add questions to an assessment outside your assigned courses."
      );
    }
    ...
    revalidatePath(`/instructor/exams/${examId}/questions`);
  }
