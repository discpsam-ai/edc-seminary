...
export default async function AdminLearningPage() {
  ...
  return (
    <AdminShell
      ...
      subtitle="Create modules, lessons, video lectures, downloadable notes, and discipleship learning streams."
    >
        ...
        <div className="border border-[#c9a84c]/20 bg-white/90 p-8">
          ...
          {!modules || modules.length === 0 ? (
            <p className="mt-8 text-[#1c2b3a]/70">
              No learning module created yet.
            </p>
          ) : (
                      ...
                      module.course_lessons.map((lesson: any) => (
                        ...
                        >
                          <div className="flex flex-wrap items-center justify-between gap-3">
                            ...
                            <span className="border border-[#c9a84c]/20 bg-[#fdfaf4] px-3 py-2 text-xs font-bold uppercase tracking-[0.15em] text-[#c9a84c]">
                              {lesson.lesson_type}
                            </span>
                          </div>
                        </div>
