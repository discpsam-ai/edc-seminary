...
export default async function AssignmentSubmissionsPage({
  ...
  return (
    <AdminShell
      ...
      subtitle="Review student submissions, apply rubric-based grading, and give instructor feedback."
    >
      <section className="space-y-8">
        <div className="border border-[#c9a84c]/20 bg-white/90 p-8">
          <div className="flex flex-wrap items-start justify-between gap-4">
            ...
            <Link href="/admin/assignments" className="btn-gold">
              Back
            </Link>
          </div>
        </div>
              ...
              >
                ...
                <form action={gradeSubmission} className="mt-8 grid gap-5">
                  ...
                  <input
                    ...
                    min="0"
                    max={
                      assignment?.grading_rubrics?.total_marks || 100
                    }
