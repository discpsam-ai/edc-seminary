...
export default async function MaterialsPage() {
  ...
  const courseIds =
    registrations?.map((item: any) => item.course_id).filter(Boolean) || [];
    ...
    >
      <section className="border border-[#c9a84c]/20 bg-white p-8">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <p className="section-label">Learning Repository</p>
            ...
            {materials.map((material: any) => (
              ...
              >
                <p className="section-label">
                  {material.courses?.code || "Course Material"}
                </p>
                ...
                <div className="mt-6 flex flex-wrap items-center justify-between gap-4">
                  <div>
                    <p className="text-sm text-[#1c2b3a]/45">Uploaded:</p>
